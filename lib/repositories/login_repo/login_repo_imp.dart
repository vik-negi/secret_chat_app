import 'package:chatapp/data/remote/api_services/login_api_service.dart';
import 'package:chatapp/repositories/login_repo/login_repo.dart';
...
class LoginRepoImp extends LoginRepo {
  ...
  Future<Map<String, dynamic>>? userSignup(Map data) async {
    dynamic response = await loginApiServices.userSignup(data);
